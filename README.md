...
## Final Phase 1 full-pre-holdout scanner
...
- historical, recent-period, recency-weighted, symbol, concentration,
  time-of-day, liquidity, outlier, and cross-sectional IC diagnostics;
...
The final configuration uses all eligible data through April 30, 2026 and
seals May 1, 2026 onward. Local `runs/`,
